...
12. Ghi nhận share event, kênh đích khi có và lượt mở link phục vụ US19; retry không tạo duplicate ngoài định nghĩa.
13. Guest không được thực hiện action Share từ MyTV vì Share là interaction; phải đăng nhập trước khi tạo share event.
...
|---|---|---|---|---|
| TC-US18-001 | Functional | C1 public | User login chọn Share | Share sheet mở với CTA + deep link, không có text comment. |
...
| TC-US18-006 | No app | Thiết bị chưa cài MyTV | Mở link | Mở MyTV Web đúng context, không mất deep-link target nếu hợp lệ. |
| TC-US18-007 | No expiry | Link cũ lâu ngày, target vẫn valid | Mở | Link vẫn hoạt động sau khi kiểm tra quyền/state hiện tại. |
| TC-US18-008 | Removed target | C1 đã Ẩn/Xóa | Mở link cũ | Mở phim/tập + “Bình luận không còn khả dụng”; không lộ C1. |
| TC-US18-009 | Invalid share state | C1 pending/rejected/hidden/deleted | Thử Share UI/API | Bị chặn; không tạo share event hợp lệ. |
| TC-US18-010 | MVP channel | Có nhiều app share cài trên device | Share | Dùng OS share sheet; chưa cần direct integration SDK/API. |
| TC-US18-011 | Tracking | Share/open retry | Kiểm tra event | Ghi nhận đúng share/open theo dedup definition. |
